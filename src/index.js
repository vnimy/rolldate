...
export class Date {
    ...
    event() {
        ...
        mask.addEventListener('click', function () { _this.destroy('mask'); })
        if (cancel) {
            cancel.addEventListener('click', function () { _this.destroy('cancel'); })
        }
        if (clean) {
            clean.addEventListener('click', function () { _this.destroy('clean'); })
        }
    ...
    destroy(event, date) {
        ...
        if (event === 'cancel') {
            if (_this.config.cancelEnd) {
                ...
                _this.config.cancelEnd.call(_this, el);
            }
        }
        if (event === 'clean') {
            if (_this.config.cleanEnd) {
                ...
                _this.config.cleanEnd.call(_this, el);
            }
        }
